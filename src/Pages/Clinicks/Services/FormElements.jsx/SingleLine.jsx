...
const SingleLine = ({field,setFormFields,i,formFields}) => {
    ...
    const handleSubmit = (e)=>{
        ...
        setFormFields((prev) =>prev.map((field, index) =>
            index === i ? { ...field, label : title,hide: hide,mandatory : mandatory,instruction : instruction } : field
          ))
          closeModal();
